    ...
    var body: some View {
        HStack(alignment: .top, spacing: 30) {
            VStack(spacing: 10) {
                Circle()
                    .fill(.white)
//                    .fill(dailyWorkout.isCompleted ? Color.brandSecondary : .white)
...
//            .foregroundColor(dailyWorkout.isCompleted ?  .white : .black)
            .padding()
//            .background(dailyWorkout.isCompleted ? Color.brandPrimary : .white)
            .hLeading()
            .cornerRadius(12)
...
//        TodayWorkoutCell(dailyWorkout: DailyWorkout(name: "thang"), workout: Workout(name: "Bench", sets: 3, reps: 5))
//    }
//}
//
//
